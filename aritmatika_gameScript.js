...
function toggleSurvivalInput() {
    ...
    if (checkbox.checked) {
        ...
        inputNumber.value = ""; // Mengosongkan input
...
function toggleForm() {
    clearInterval(timer);
    document.getElementById("tombolPengaturan").style.display = "none";
...
function mulaiGame() {
    ...
    document.getElementById("tombolPengaturan").style.display = "block";
    generateSoal(level);
    resetHealth();         
